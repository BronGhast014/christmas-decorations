...
execute unless entity @e[type=armor_stand,tag=spawn_BGCD_mistletoe,distance=..1,limit=1,sort=nearest] if entity @s[gamemode=survival] run loot give @s loot bgcd:items/mistletoe
