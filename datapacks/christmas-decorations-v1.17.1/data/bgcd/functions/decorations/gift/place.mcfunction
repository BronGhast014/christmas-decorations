...
execute if entity @s[scores={BGCD_rnd=1}] run summon armor_stand ~ ~ ~ {Small:1b,Marker:1b,Invisible:1b,Tags:["BGCD_gift_model","BGCD_item"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:4014005}}]}
execute if entity @s[scores={BGCD_rnd=2}] run summon armor_stand ~ ~ ~ {Small:1b,Marker:1b,Invisible:1b,Tags:["BGCD_gift_model","BGCD_item"],ArmorItems:[{},{},{},{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:4014006}}]}
...
playsound block.azalea_leaves.place block @a ~ ~ ~ 1 1
