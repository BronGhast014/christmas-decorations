...
summon bee ~ ~ ~ {NoGravity:1b,Silent:1b,DeathLootTable:"bgcd:gifts/gift",PersistenceRequired:1b,NoAI:1b,Health:1f,Tags:["BGCD_item","BGCD_gift"],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:1999980,ShowParticles:0b}],Attributes:[{Name:"generic.max_health",Base:0}]}
