...
summon slime ~ ~ ~ {DeathLootTable:"bgcd:gifts/gift",NoAI:1b,Health:1f,Size:0,Tags:["BGCD_gift","CmasItem"],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:99999,ShowParticles:0b}],Attributes:[{Name:generic.maxHealth,Base:1}]}
